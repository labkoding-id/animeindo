            ...
            <div class="col-12">
                <div class="pagination-wrapper">
                    <div class="pagination">
                        ...
                        <?php if($current != 1): ?>
                        <a class="prev page-numbers" href="<?=$prev != "1" ? base_url('season/').$season.'/'.$prev : base_url() ?>">Prev</a>
                        <?php else:?>
                        ...
                        <?php if($x <= $page):?>
                            <a class="page-numbers" href="<?=base_url('season/').$season.'/'.$x?>"><?=$x?></a>
                        <?php endif;?>
                        <?php endfor;?>
                        <?php if($current != $page): ?>
                        <a class="next page-numbers" href="<?=base_url('season/').$season.'/'.$next?>">Next</a>
                        <?php else:?>
                        <a class="prev page-numbers" href="javascript:void(0)">--</a>
                        <?php endif;?>
                    </div>
